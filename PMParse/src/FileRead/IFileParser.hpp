...
public:
    ...
    virtual std::string getPmMeasurementTypeForPmTarget(const boost::property_tree::ptree& pmNode) const = 0;
    virtual std::string getPmMeasurementTypeForWBTS(const boost::property_tree::ptree& pmNode) const = 0;
